...
class ApiSDKJsonClient():
    ...
    def initConfig(self):
        if (ApiSDKJsonClient.actionconf==None):
            ...
            ApiSDKJsonClient.urlconf=cf.get("baidu-api", "serverUrl")
            ApiSDKJsonClient.usernameconf=unicode(cf.get("baidu-api", "username"),"utf-8")
            ApiSDKJsonClient.passwordconf=cf.get("baidu-api", "password")
            ApiSDKJsonClient.tokenconf=cf.get("baidu-api", "token")
            ApiSDKJsonClient.targetconf=cf.get("baidu-api", "target")
            ApiSDKJsonClient.actionconf=cf.get("baidu-api", "action")
